...
import TaxDocumentsSection from "../components/taxes/TaxDocumentsSection.jsx";
import DraftReturnCard from "../components/taxes/DraftReturnCard.jsx";
import TaxProjectionCard from "../components/taxes/TaxProjectionCard.jsx";
...
export default function Taxes() {
  ...
  return (
    <div>
      ...
      {/* W-4 Optimizer Wizard Modal — rendered at root to overlay everything */}
      <W4WizardModal open={wizardOpen} onClose={() => setWizardOpen(false)} />
    </div>
  );
}
